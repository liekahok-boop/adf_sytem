...
$categoriesIncome = $db->fetchAll("SELECT id FROM categories WHERE category_type = 'income'");
$categoriesExpense = $db->fetchAll("SELECT id FROM categories WHERE category_type = 'expense'");
